        ...
        <div className="p-4 bg-white">
          <div className="space-y-4">
            {safePoints.map((point, index) => (
              <div key={`diagnosis-${index}`} className="flex items-start gap-3 p-3 rounded-lg border border-rose-100 bg-rose-50">
            ...
            {safePoints.length === 0 && (
              <div className="text-gray-500 text-center p-4">No diagnosis points available</div>
            )}
          </div>
        </div>
      </div>
        ...
        <div className="p-4 bg-white">
          <div className="space-y-4">
            {safeTreatments.map((point, index) => (
              <div key={`treatment-${index}`} className="flex items-start gap-3 p-3 rounded-lg border border-green-100 bg-green-50">
            ...
            {safeTreatments.length === 0 && (
              <div className="text-gray-500 text-center p-4">No treatment points available</div>
            )}
          </div>
        </div>
      </div>
