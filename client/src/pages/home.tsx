...
export default function Home() {
  // Fetch count of deghibs created
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-4">
              <div className="flex items-center justify-center gap-4 mb-4">
                <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-blue-100 text-blue-800 text-sm font-medium">
                  <Sparkles className="h-4 w-4 mr-2" /> AI-Powered Technology
                </div>
                {statsData && (
                  <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-gradient-to-r from-green-100 to-blue-100 border border-blue-200 shadow-sm text-blue-800 text-sm font-medium animate-pulse">
              ...
              <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
                Has your imagery been infected with excessive whimsy? Our
                cutting-edge AI will diagnose and cleanse your images of Ghibli
                contamination.
              </p>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-4">
              <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100 text-center hover:shadow-lg transition-shadow duration-300">
                ...
                <p className="text-gray-600 text-sm">
                  Our AI analyzes your images to detect Ghibli contamination
              ...
              <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100 text-center hover:shadow-lg transition-shadow duration-300">
                ...
                <p className="text-gray-600 text-sm">
                  We carefully extract whimsical elements with our proprietary
              ...
              <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100 text-center hover:shadow-lg transition-shadow duration-300">
                ...
                <p className="text-gray-600 text-sm">
                  We restore your image to a practical, mundane state free from
                  magical influences
                </p>
              </div>
            </div>
