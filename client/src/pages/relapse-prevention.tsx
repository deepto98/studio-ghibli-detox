            ...
            <div className="space-y-6">
              <div className="border border-gray-200 rounded-lg p-4">
                <h3 className="font-medium text-lg">
                  12-Step Program: "From Totoro to Reality: A Journey Back"
                </h3>
                <p className="text-sm text-gray-600 mt-2">
                  Our comprehensive recovery program for severe cases of Ghibli
                  addiction. Weekly group sessions available online.
                </p>
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                <h3 className="font-medium text-lg">
                  Monthly Reality Check Newsletter
                </h3>
                <p className="text-sm text-gray-600 mt-2">
                  Stay updated with the latest techniques to identify and resist
                  emerging Ghibli influences in your daily life.
                </p>
              ...
              <div className="border border-gray-200 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600 mt-2">
                  For moments of weakness when you feel the urge to add sparkles
                  to ordinary objects or believe your cat might be a forest
                  spirit in disguise.
                </p>
